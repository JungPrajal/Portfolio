            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit About</span></h4>
                                                    ...
                                                    if ($file_size <= 2 * 1024 * 1024) {
                                                        ...
                                                        if (in_array($extlink, ['jpg', 'png', 'jpeg'])) {
                                                            ...
                                                            if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
                                                                $query = "UPDATE about SET title='$title', description='$description', image='$finalname', status='$status', updated_at=NOW() WHERE id=$id";
