            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage About</span></h4>
                                ...
                                <div class="col-12">
                                    <div class="card shadow-sm">
                                        <div class="card-header d-flex align-items-center justify-content-between bg-primary text-white">
                                            <h4 class="fw-bold mb-0">Add about</h4>
                                            <a class="btn btn-light btn-sm" href="index.php" role="button">Manage about</a>
                                        </div>
                                        <div class="card-body">
                                            <?php 
                                            if (isset($_POST['save'])) {
                                                        ...
                                                        if ($filesize <= 2 * 1024 * 1024) {
                                                            if ($ext == "jpg" || $ext == "png") {
                                                                if (move_uploaded_file($filetmp, '../uploads/' . $finalfilename)) {
                                                                    $query = "INSERT INTO about (title, description, image, status) VALUES ('$title', '$description', '$finalfilename', '$status')";
