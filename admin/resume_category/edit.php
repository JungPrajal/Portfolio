            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit Resume Category</span></h4>
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        if (isset($_GET['id'])) {
                                            $id = $_GET['id'];
                                            $sql = "SELECT * FROM resume_category WHERE id = '$id'";
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            if ($title !== "" && $description !== "" && $status !== "") {
                                                $query = "UPDATE resume_category SET title='$title', description='$description', status='$status' WHERE id=$id";
