    ...
    <div class="container-wrapper">
        <div class="table-responsive">
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                <h4 class="fw-bold py-3 mb-4"><a class="btn btn-primary btn-sm" href="create.php" role="button"> Create Slider</a></h4>
                        ...
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-info btn-sm" href="show.php?id=<?php echo $row['id']; ?>" role="button">Edit</a>
