            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit files</span></h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            if ($title !== "" && $description !== "" && $status !== "") {
                                                $query = "UPDATE files SET title='$title', description='$description', status='$status' WHERE id=$id";
                                                $result = mysqli_query($con, $query);
                                                if ($result) {
                                                    echo "<div class='alert alert-success'>Files updated successfully.</div>";
                                                    echo "<meta http-equiv=\"refresh\" content=\"2;URL=index.php\">";
                                                } else {
                                                    echo "<div class='alert alert-danger'>Failed to update files.</div>";
                                                    echo "<meta http-equiv=\"refresh\" content=\"2;URL=index.php\">";
                                                }
                                            } else {
